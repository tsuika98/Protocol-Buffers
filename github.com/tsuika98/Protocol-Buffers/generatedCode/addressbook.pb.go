...
// define message definitions that will be used by the protobuf compilier to generate our Go code
type Person struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Name        string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // these numbers next to the types are tags used for binary encoding
	Id          int32                  `protobuf:"varint,2,opt,name=id,proto3" json:"id,omitempty"`
	Email       string                 `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"`
	Phones      []*Person_PhoneNumber  `protobuf:"bytes,4,rep,name=phones,proto3" json:"phones,omitempty"` // repeated means that a person message can have any number of PhoneNumber types, stored in phones
...
type AddressBook struct {
	...
	People []*Person `protobuf:"bytes,1,rep,name=people,proto3" json:"people,omitempty"` // the address book can contain any number of people
}
...
var file_addressbook_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x73, 0x75, 0x69, 0x6b, 0x61, 0x39, 0x38, 0x2f, 0x50, 0x72, 0x6f,
	0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2d, 0x42, 0x75, 0x66, 0x66, 0x65, 0x72, 0x73, 0x2f, 0x67, 0x65,
	0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x64, 0x43, 0x6f, 0x64, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
